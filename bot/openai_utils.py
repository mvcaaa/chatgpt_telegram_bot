...
class ChatGPT:
    """
    A class used to interact with OpenAI's ChatGPT API
    ...
    Methods
    -------
    send_message(message, dialog_messages=[], chat_mode="assistant")
        Sends a message to the chatbot and returns the answer
